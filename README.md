...
### Usage
Download the [latest release](https://github.com/deciduously/attendance/releases/tag/v0.3.0-r2) and decompress it.  Run the executable `attendance-server` (e.g. `cd attendance-v0.3.0/ && ./attendance-server`) and point your browser to `localhost:3000`.  `Rocket.toml` can be used to set the target port.
